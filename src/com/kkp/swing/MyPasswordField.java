...
public class MyPasswordField extends JPasswordField {
    ...
    public MyPasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/kkp/icon/show.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/kkp/icon/hidden.png")).getImage();
    ...
    private void isShowing(boolean action) {
